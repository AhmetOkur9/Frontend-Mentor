const buttonArray = document.querySelectorAll('.star-btn')
...
function eventListeners() {
    buttonArray.forEach(function (btn, index) {
        btn.addEventListener('click', function (event) {
            let currentStar = buttonArray[index]
            buttonArray.forEach(function (e) {
                e.classList.remove('selected-star')
            })
            btn.classList.add('selected-star')

        })
    })
    submitButton.addEventListener('click', function (event) {
        buttonArray.forEach(function (btn,index) {
            if (btn.classList.contains("selected-star")) {
                card.innerHTML = `<div class="success-class">
      <div>
      ...
      <div>
        <h3 id="info">You selected ${index+1} out of 5</h3>
      </div>
      <div>
        <h2>Thank you!</h2>
      </div>
